    ...
    myCube()                                        // Initialize the cubeControl object
{
    ...
    // Connect test functions to temporary UI buttons to display data parsing functionality
    connect(ui->pushButtonTest1, &QPushButton::clicked, this, &RGBLEDCCS::test1);
    connect(ui->pushButtonTest2, &QPushButton::clicked, this, &RGBLEDCCS::test2);
    connect(ui->pushButtonTest3, &QPushButton::clicked, this, &RGBLEDCCS::test3);
    connect(ui->pushButtonTest4, &QPushButton::clicked, this, &RGBLEDCCS::test4);
    connect(ui->pushButtonTest5, &QPushButton::clicked, this, &RGBLEDCCS::test5);
}
...
// Temporary function to display execution of importCubeData function
void RGBLEDCCS::test1()
{
    // Pass importCubeData function QString of size 64 to simulate loading pattern from database
    importCubeData("0123456701234567012345670123456701234567012345670123456701234567");
}


// Temporary function to display execution of importCubeData function
void RGBLEDCCS::test2()
{
    // Pass importCubeData function QString of size 64 to simulate loading pattern from database
    importCubeData("0000000011111111222222223333333344444444555555556666666677777777");
}


// Temporary function to display execution of importCubeData function
void RGBLEDCCS::test3()
{
    // Pass importCubeData function QString of size 64 to simulate loading pattern from database
    importCubeData("0001020304050607000102030405060700010203040506070001020304050607");
}


// Temporary function to display execution of importCubeData function
void RGBLEDCCS::test4()
{
    // Pass importCubeData function QString of size 64 to simulate loading pattern from database
    importCubeData("1111222233334444111122223333444411112222333344441111222233334444");
}


// Temporary function to display execution of importCubeData function
void RGBLEDCCS::test5()
{
    // Pass importCubeData function QString of size 64 to simulate loading pattern from database
    importCubeData("7654321076543210765432107654321076543210765432107654321076543210");
}
